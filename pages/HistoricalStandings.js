...
const historicalStandings = () => {
  return (
    <>
      ...
      <div>
        <h1 className='text-2xl font-extrabold text-center mt-20'>Defunct Franchises</h1>
        {defunct_franchises.map((defunct) => {
          return (
            <>
            <div className='border-white border-2 w-11/12 md:w-1/2 text-center mx-auto my-2'>
              <p className="text-xl text-yellow-600 font-extrabold my-3">
                {defunct.name}
              </p>
